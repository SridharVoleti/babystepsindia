...
export const PLATFORM_API_CONTRACTS = {
  ...
  sessionDisconnect: contract({ contractKey: "learner-session.disconnect", method: "POST", path: "/v1/internal/learner-sessions/{sessionId}/disconnect",
    ...
    ...write, errors: commonErrors, rateLimit: "per_session" }),
  sessionExitState: contract({ contractKey: "learner-session.exit-state", method: "GET", path: "/v1/internal/learner-sessions/{sessionId}/exit-state",
    canonicalAction: "app.session.exit_state.read", requestSchema: "SessionExitStateRequestV1", responseSchema: "SessionExitStateResponseV1",
    ...read, errors: commonErrors, rateLimit: "per_session" }),
  sessionFinish: contract({ contractKey: "learner-session.finish", method: "POST", path: "/v1/internal/learner-sessions/{sessionId}/finish",
    canonicalAction: "app.session.finish", requestSchema: "SessionIntentionalFinishRequestV1", responseSchema: "SessionCompleteResponseV1",
    ...write, errors: commonErrors, rateLimit: "per_session" }),
  sessionMarkResumable: contract({ contractKey: "learner-session.mark-resumable", method: "POST", path: "/v1/internal/learner-sessions/{sessionId}/mark-resumable",
    canonicalAction: "app.session.mark_resumable", requestSchema: "SessionMarkResumableRequestV1", responseSchema: "SessionExitStateResponseV1",
    ...write, errors: commonErrors, rateLimit: "per_session" }),
