...
async function activate(key: string) {
  ...
  await processVerifiedPaymentEvent({ provider: intent.provider, environment: intent.provider_environment,
...
beforeEach(async () => {
  ...
  productId = (await defineProductVersion({ id: "product-en004-lazy", slug: "en004-lazy-monthly",
