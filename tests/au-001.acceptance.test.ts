...
const criteria: Criterion[] = [
  ...
  { id: 19, title: "RLS and repository scope are enabled", verify: () => { expect(Object.keys(supabaseTableAccess)).toHaveLength(118); has(sources.rls(), /force row level security/); } },
